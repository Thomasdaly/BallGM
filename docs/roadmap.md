...
Draft decisions — the last consumer of the assessment foundation — remains unbuilt, as do the naive placeholders this milestone will eventually replace (`AutoResignToRosterFloor`, `DraftDay`'s best-prospect-left selection).
