...
As of this writing: Milestones 0 (repo/architecture proof), 1 (league and roster foundation), 2 (thin playable UI slice), 3 (contracts and cap ledger), 4 (draft assets), 5 (trade engine), 6a (contract offers and signing routes), and **6b** (the free-agency market) are done. Milestone 7 — calendar and game simulation — is next.
